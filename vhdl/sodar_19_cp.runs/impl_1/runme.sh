...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar_19_cp/sodar_19_cp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar_19_cp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sodar_19_cp_wrapper.tcl -notrace
