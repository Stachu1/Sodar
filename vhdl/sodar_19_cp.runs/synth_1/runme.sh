...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar_19_cp/sodar_19_cp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar_19_cp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sodar_19_cp_wrapper.tcl
