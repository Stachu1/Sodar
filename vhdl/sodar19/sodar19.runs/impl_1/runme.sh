...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar19/sodar19.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar19_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sodar19_wrapper.tcl -notrace
