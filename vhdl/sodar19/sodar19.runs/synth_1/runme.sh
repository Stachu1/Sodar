...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar19/sodar19.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar19_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sodar19_wrapper.tcl
