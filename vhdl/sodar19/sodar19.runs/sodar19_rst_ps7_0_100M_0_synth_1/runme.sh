...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar19/sodar19.runs/sodar19_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar19_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sodar19_rst_ps7_0_100M_0.tcl
