...
HD_PWD='C:/Users/plywa/Digital designe vivado/sodar19/sodar19.runs/sodar19_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sodar19_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sodar19_xbar_0.tcl
